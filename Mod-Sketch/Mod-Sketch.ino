/* Mod Sketch v0.2.4 -- written by Craig Durkin / Comingle. */
...
const String txtVersion = "Dilduino v0.2.4";
#define USERPATTERN 11 // Position in which userPattternPlayer is added
...
void setup() {
  ...
  Toy.addPattern(userPatternPlayer); // USERPATTERN = 11
  Toy.addPattern(allStop);
